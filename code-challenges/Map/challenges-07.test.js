...
const charCode = (arr) => arr.map((str) => str.charCodeAt(0));
...
------------------------------------------------------------------------------------------------ */
// let obj = {1:'odd',0:'even'}
const evenOdd = (arr) =>
  arr.map((num) => (num % 2 ? 'odd' : Number.isFinite(num) ? 'even' : 'N/A'));
...
const extractStats = (arr) =>
  arr.map((obj) => ({ name: obj.stat.name, total: obj.effort + obj.baseStat }));
