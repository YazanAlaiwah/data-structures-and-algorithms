...
const countNumberOfElements = (arr) => arr.reduce((a, b) => a + 1, 0);
...
const countNumberOfChildren = (arr) =>
  arr.reduce((a, b) => (b.children ? a + b.children.length : a + 0), 0);
...
const countPrimeNumbers = (arr) =>
  arr.reduce((a, b) => (isPrime(b) ? a + 1 : a + 0), 0);
...
const extractStat = (statName, arr) =>
  arr.reduce((a, b) => (b.stat.name === statName ? b : a), null);
...
//   arr
//     .reduce((a, b) => (/a/g.test(b.name) ? [...a, b] : a), [])
//     .reduce((a, b) => (b.children ? [...a, ...b.children] : a), []);

// this one is better what challenge ask above
const extractChildren = (arr) =>
  arr.reduce(
    (a, b) => (/a/g.test(b.name) && b.children ? [...a, ...b.children] : a),
    []
  );
